-- Immutable baseline migration for the PostgreSQL control datastore.
-- This numbered file promotes the earlier control-store bootstrap into the package-owned migration chain.
...
COMMENT ON TABLE restore_verification.restore_drill_result_register IS
  'Restore-drill evidence aligned to the active schema-reader compatibility window.';
